...
public final class PlanningProgress {
    public enum Stage {
        CACHE(0, 2), COAST(2, 8), EROSION(8, 46), RIVERS(46, 55), COSTS(55, 75), PLACEMENT(75, 78), TEMPERATURE(78, 81), SEEDS(81, 84), GROWTH(84, 90), FILLER(90, 94), TRANSITION(94, 95), VALIDATION(95, 98), SAVE(98, 100);
        final int start, end;
