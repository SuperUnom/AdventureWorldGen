...
public class TerrainRecipeAudit {
 public static void main(String[] args)throws Exception {
  ...
  var config=new AdventureWorldConfigParser().parse(Files.readString(Path.of("neoforge/src/main/resources/data/adventureworldgen/adventureworldgen/profiles/default.json")));
  ...
  for(int a=1;a<args.length;a++) {
   ...
   var terrain=new RegionTerrain(seed,PlannerProfile.V2,capacity,config.world().terrain(),config);
