...
| 服务器生命周期、计划查询、Minecraft 区块与结构执行 | [运行时与 worldgen](systems/runtime-worldgen.md) |
| 作者 JSON、缺省行为与验证 | [Profile 参考](reference/profile.md) |
| 冻结格式、身份或 READY 恢复 | [Plan-v2 参考](reference/plan-v2.md) |
| 数据包覆盖、第三方群系和结构 | [适配器参考](reference/adapters.md) |
...
关键事实来源集中列在 [AGENTS.md](../AGENTS.md#source-of-truth)。
